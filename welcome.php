...
<head>
    ...
    <title><?php echo $str_event_short ?> Enrollment - Welcome</title>
</head>
<body>
...
<div class="wrapper">
	...
	<div class="page">
		...
		<h1>Welcome to the <?php echo $str_event_name ?> enrollment system!</h1>
		<p>	
			Enrollment to the <?php echo $str_event_short ?> event is handled through this system. You will be guided through the enrollment 
		...
		<p>
            ...
            until <?php echo $submission_deadline ?>. Before the deadline is over, you may revisit your enrollment, change it 
		...
		<p>
			Competitors and staff for <?php echo $str_event_short ?> are assigned by the national representatives, and the enrollment forms 
