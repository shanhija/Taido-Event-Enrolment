...
<form id="enrollForm" action="http://koti.kapsi.fi/~shanhija/mm2013/interface.php">
<div class="pages">
	...
	<div class="page" id="personalPage">
		...
		<p>Please fill in your personal information. Competitors and staff of WTC2013 will see a field named "Role" with the corresponding role.
		If this is not the case, please contact your national representative.</p>
	...
	<div class="page" id="ifgTeamsPage">
		...
		<div class="dantai requireValue" data-variable="eventB19">
			...
			<label for="teamB19_name"><span class="title">Team name</span>
				...
				<div id="teamB19_loading" class="loading"><img src="images/ajax-loader.gif"></div>
				<div id="teamB19_nameok" class="nameok"><img src="images/tick.png"></div>
			</label>
		...
		<div class="dantai requireValue" data-variable="eventB21">
			...
			<label for="teamB21_name"><span class="title">Team name</span>
				...
				<div id="teamB21_loading" class="loading"><img src="images/ajax-loader.gif"></div>				
				<div id="teamB21_nameok" class="nameok"><img src="images/tick.png"></div>
			</label>
		...
		<div class="dantai requireValue" data-variable="eventB22">
			...
			<label for="teamB22_name"><span class="title">Team name</span>
				...
				<div id="teamB22_loading" class="loading"><img src="images/ajax-loader.gif"></div>				
				<div id="teamB22_nameok" class="nameok"><img src="images/tick.png"></div>
			</label>
	...
	<div class="page" id="judgePage">
		...
		<p>
			...
			you may enroll as a judge in WTC. A judge in IFG should also have 4 dan and be experienced in judging. However, if you have a recommendation from your national taido organization, you may apply the right to judge in the IFG event. Finnish Taido Association and
			World Taido Federation will review all judge enrollments and decide if a person is qualified. 
		</p>
		<p>
	...
	<div class="page hotel" id="hotelPage">
		...
		<div class="hotelDetails requireEnabled" data-variable="passportNumber">			
			...
			<div class="hotelDetail">
				...
				<input type="text" name="passportNumber" class="variable" data-variable="passportNumber"></input>
	...
	<div class="page" id="summaryPage">
		...
		<div class="summary">
			...
			<p>
				Please check that the above information is correct. When you are confident with the content, submit your information as enrollment to the WTC 2013 event. You may revisit your submission and resubmit. You may also retract your submission. You are able to do this until the submission deadline 15.4.2013.
			</p>
...
<div id="dialog-confirm-remove-self-from-team" title="Really remove yourself?" class="dialog">
	<p>Do you really want to remove yourself from the team? If you remove yourself and submit your enrollment, you cannot later add yourself back to the team anymore. Someone still in the team has to do it.
	</p>
</div>
